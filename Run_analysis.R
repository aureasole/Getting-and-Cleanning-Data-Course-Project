...
setwd("C:/Users/Àurea/Coursera courses/Getting and cleanning data/Course Project/UCI HAR Dataset")
...
setwd("C:/Users/Àurea/Coursera courses/Getting and cleanning data/Course Project/UCI HAR Dataset/test")
...
setwd("C:/Users/Àurea/Coursera courses/Getting and cleanning data/Course Project/UCI HAR Dataset/train")
...
setwd("C:/Users/Àurea/Coursera courses/Getting and cleanning data/Course Project/UCI HAR Dataset")
cdata_tidy_data<-write.table(cdata,row.names = FALSE)
save(cdata_tidy_data, file="output.txt")
